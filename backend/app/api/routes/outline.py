...
from app.services.outline_generation_flow import (
    PreparedOutlineGeneration,
    build_outline_generation_guidance as _build_outline_generation_guidance,
    extract_target_chapter_count as _extract_target_chapter_count,
    prepare_outline_generation as _prepare_outline_generation,
...
def generate_outline(
    ...
    request_id = request.state.request_id
    prepared: PreparedOutlineGeneration | None = None
